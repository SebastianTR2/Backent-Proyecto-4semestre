...
builder.Services
    ...
    .AddType<Machly.Api.GraphQL.Types.TariffAgroType>()
    .AddType<Machly.Api.GraphQL.Types.KmTariffType>()
    .BindRuntimeType<MongoDB.Bson.BsonValue, StringType>()
    .BindRuntimeType<MongoDB.Bson.ObjectId, StringType>()
    .AddAuthorization()
